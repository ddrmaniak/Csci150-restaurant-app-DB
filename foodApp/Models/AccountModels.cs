...
namespace foodApp.Models
{
    ...
    public interface IMembershipService
    {
        ...
        MembershipCreateStatus CreateUser(string userName, string password, int? number);
    ...
    public class AccountMembershipService : IMembershipService
    {
        ...
        public MembershipCreateStatus CreateUser(string userName, string password, int? number)
        {
            ...
            return makeUser(userName, password, number);
        }
        ...
        public bool ChangePassword(string userName, string oldPassword, string newPassword)
        {
            ...
            try
            {
                ...
                return changePass(userName, oldPassword, newPassword);
            }
